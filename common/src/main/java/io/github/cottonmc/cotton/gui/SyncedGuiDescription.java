...
public class SyncedGuiDescription extends ScreenHandler implements GuiDescription {
	...
	public final ServerPlayerEntity getServerPlayer() {
		return getNetworkSide() == NetworkSide.SERVER ? (ServerPlayerEntity) playerInventory.player : null;
	}
	...
	//		return NetworkManager.getSender((ServerPlayerEntity) playerInventory.player);
	//	} else {
